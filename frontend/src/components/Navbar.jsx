...
import { GraduationCap, ChartNoAxesCombined, MenuIcon, XIcon, UserIcon, PaletteIcon } from 'lucide-react'
...
function Navbar() {
  ...
  return (
    <div className="drawer drawer-end">
      <input id="settings-drawer" type="checkbox" className="drawer-toggle" ref={drawerCheckboxRef} />
